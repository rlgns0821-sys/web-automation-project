package com.korea.boardEx.mybatis;
...
@MapperScan("com.korea.boardEx.mapper")  // Mapper를 스캔할 패키지
public class MyBatisConfig {
	...
	public SqlSessionFactory sqlSessionFactory() throws IOException {
		...
		// vo에 @Alias("")를 써서 xml resultType="" 부분에 alias 함축어 사용 가능
		sfb.setTypeAliasesPackage("com.korea.boardEx.bean.vo");
